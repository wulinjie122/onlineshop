...
public class Setting implements Serializable {
    ...
    public void setLargeProductImageWidth(
    ...
    public void setLargeProductImageHeight(
    ...
    public void setMediumProductImageWidth(
    ...
    public void setMediumProductImageHeight(
    ...
    public void setThumbnailProductImageWidth(
    ...
    public void setDefaultLargeProductImage(
    ...
    public void setDefaultMediumProductImage(
    ...
    public void setDefaultMarketPriceScale(
    ...
    public void setDisabledUsername(String disabledUsername) {
        if (disabledUsername != null) {
            disabledUsername = disabledUsername.replaceAll(
                    "[,\\s]*,[,\\s]*", ",").replaceAll("^,|,$", "");
        }
    ...
    public void setStockAllocationTime(
    ...
    public BigDecimal setScale(BigDecimal amount) {
        ...
        return amount.setScale(getPriceScale().intValue(),
                roundingMode);
    }
