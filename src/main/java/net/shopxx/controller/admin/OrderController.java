...
public class OrderController extends BaseController {
    ...
    public String refunds(Long orderId, Long paymentMethodId, Refunds refunds, RedirectAttributes redirectAttributes) {
        ...
        PaymentMethod paymentMethod = this.paymentMethodService.find(paymentMethodId);
    ...
    public String shipping(Long orderId, Long shippingMethodId,
                           ...
                           RedirectAttributes redirectAttributes) {
        Order order = (Order) orderService.find(orderId);
        if (order == null)
            return "/admin/common/error";
    ...
    public String returns(Long orderId, Long shippingMethodId,
        ...
        if (order.isLocked(admin)) {
            ...
            returns.setSn(snService.generate(net.shopxx.entity.Sn.Type.returns));
    ...
    public Map calculate(Order order, Long areaId, Long paymentMethodId,
        ...
        order.setPaymentMethod((PaymentMethod) paymentMethodService.find(paymentMethodId));
        ...
        Order order1 = (Order) orderService.find(order.getId());
        if (order1 == null) {
            hashmap.put("message",
