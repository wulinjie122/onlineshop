...
public class StaticServiceImpl implements StaticService, ServletContextAware {
    ...
    public int build(Article article) {
        ...
        delete(article);
        net.shopxx.Template localTemplate = this.templateService.get("articleContent");
        int i = 0;
    ...
    public int buildIndex() {
        net.shopxx.Template template = this.templateService.get("index");
    ...
    public int buildSitemap() {
        int i = 0;
        net.shopxx.Template localTemplate1 = this.templateService.get("sitemapIndex");
        net.shopxx.Template localTemplate2 = this.templateService.get("sitemap");
        HashMap localHashMap = new HashMap();
    ...
    public int buildOther() {
        int i = 0;
        net.shopxx.Template localTemplate1 = this.templateService.get("shopCommonJs");
        net.shopxx.Template localTemplate2 = this.templateService.get("adminCommonJs");
